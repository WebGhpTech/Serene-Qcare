    ...
    <section className=' bg-secondary h-[100vh]'>
      ...
      <div className='pt-[200px] w-full pb-10 text-white ml-[100px] justify-center '>
          <div className='flex '>
            ...
            <span className='leading-1 text-primary text-7xl font-bold font-[60px]'>SQC is the place<br/> for all</span>
           </h1>
           <img 
           src={about} 
           width={584}
...
<div className='pt-0 pb-0 bg-textGray '>
   <div className=' ml-[50px]  flex xl:justify-wrap items-center max-xl:flex-col-reverse gap-5 max-container max-sm:mt-60 h-[796px] '>
